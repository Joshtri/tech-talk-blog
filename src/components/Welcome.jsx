  ...
  return (
    <div className=" text-black py-7">
      <div className="container mx-auto px-10">
        <div className="bg-gradient-to-r from-gray-200 to-white bg-opacity-20 p-5 rounded-lg shadow-lg transition-opacity duration-1000 ease-in-out opacity-0 animate-fadeIn">
