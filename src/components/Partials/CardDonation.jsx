    ...
    >
      <div className="modal-content p-6 bg-white rounded-lg shadow-md dark:bg-gray-800 w-full max-w-md text-center">
        ...
        <div className="flex justify-center">
          <img src={saweriaMe} alt="Gambar" className="w-64 h-auto" />
        </div>

        <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400 text-justify mt-4">
          Scan QR Code Saweria ini untuk otomatis masuk ke halaman donasi. Atau bisa ke{' '}
          <a className="underline" target="_blank" href="https://saweria.co/yostri">
        ...
        <Button className="bg-blue-500 text-white px-3 py-2 rounded-lg mt-4 hover:bg-blue-600" onClick={onRequestClose}>
          Close
        </Button>
      </div>
    </Modal>
